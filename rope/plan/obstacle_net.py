#!/usr/bin/env python3
"""Train and conformalize a rope latent obstacle classifier from collected obstacle data."""
...
def log_progress(message: str) -> None:
    print(f"[rope_obstacle_net] {message}", flush=True)
...
def load_obstacle_dataset(data_path: Path) -> dict[str, Any]:
    ...
    required = ("pixels", "label", "train_idx", "calibration_idx")
...
def main() -> None:
    ...
    log_progress("Loading rope world model and encoding train, validation, and calibration frames.")
