#!/usr/bin/env python3
"""Compute a calibrated constant error covariance from the first half of Rope error data."""
...
def main() -> None:
    ...
    n_fit = n_total // 2
    if n_fit < 2:
        raise ValueError(f"Need at least two errors in the first half; got {n_fit}.")
    ...
    print(f"q_fixed={q_fixed:.6f}, state_dim={state_dim}, first_half_samples={n_fit}")
