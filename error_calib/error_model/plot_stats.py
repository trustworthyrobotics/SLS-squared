...
@torch.no_grad()
def plot_state_pdfs(dataset, start_idx, end_idx, save_path="state_pdfs_kde.png"):
    """
...
def compute_and_save_quantile(
    ...
    plot_state_pdfs(dataset, start_idx=calib_start, end_idx=n_total, save_path="state_pdfs_kde.png")
...
if __name__ == "__main__":
    ...
    CKPT_PATH = "lightning_logs/version_14/checkpoints/best-error-model-epoch=1596.ckpt"
