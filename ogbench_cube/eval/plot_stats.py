...
@torch.no_grad()
def plot_sigma_eigenvalues(model, dataloader, save_path="ogbench_cube/eval/sigma_eigenvalues.png"):
    """
...
@torch.no_grad()
def plot_state_pdfs(dataset, start_idx, end_idx, save_path="ogbench_cube/eval/state_pdfs_kde.png"):
    """
...
def compute_and_save_quantile(
    ...
    plot_sigma_eigenvalues(model, calib_loader, save_path="ogbench_cube/eval/sigma_eigenvalues.png")
    ...
    plot_state_pdfs(dataset, start_idx=calib_start, end_idx=n_total, save_path="ogbench_cube/eval/state_pdfs_kde.png")
...
if __name__ == "__main__":
    ...
    DATA_PATH = "ogbench_cube/eval/ogbench_one_step_error_data_embed_8.pt"  # Path to the dataset generated by generate_error.py
    # Using the checkpoint filename visible in your screenshot
    CKPT_PATH = "ogbench_cube/models/err_pred_logs/cube_experiment_embed_8/version_1/checkpoints/best-error-model-epoch=3290.ckpt"
